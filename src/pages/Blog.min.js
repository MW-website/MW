...
//   return (
//     <>
//       {/* === MAIN PAGE CONTENT (your hero + cards) === */}
//       {/* ... keep your existing hero, big card, small card, etc. here ... */}
//       {/* (I'm keeping it short for clarity – just paste your original main content here) */}

//       {/* === JOURNAL FULLSCREEN MODAL === */}
//       <AnimatePresence>
//         {showJournal && (
//           <>
//             <motion.div
...
//                       <img
//                         src={`https://images.unsplash.com/photo-15${post.id}05774583-5a5e2f0c5d2e?w=800&h=1000&fit=crop&auto=format&q=80`}
//                         alt={post.title}
...
//                     {selectedPost.onSale && <span className="text-red-600 text-sm font-medium">ON SALE</span>}
//                   </div>

//                   <div className="mt-6 flex items-center gap-2">
//                     {[...Array(4)].map((_, i) => <Star key={i} size={18} fill="#f59e0b" className="text-amber-500" />)}
//                     <Star size={18} className="text-gray-300" />
//                     <span className="text-sm text-gray-600 ml-2">(90 reviews)</span>
//                   </div>

//                   <div className="mt-10">
//                     <p className="text-sm uppercase tracking-wider text-gray-500 mb-3">Colors</p>
//                     <div className="flex gap-3">
//                       <button className="w-10 h-10 rounded-full border-2 border-gray-300 bg-[#f5f5f4]" />
...
//       {/* === FIXED FLOATING BUTTON (no more duplicate onClick!) === */}
//       <button
